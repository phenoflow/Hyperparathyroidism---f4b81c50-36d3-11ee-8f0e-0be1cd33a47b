...
(async () => {
  ...
  await fs.writeFile("hyperparathyroidism-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hyperparathyroidism-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
